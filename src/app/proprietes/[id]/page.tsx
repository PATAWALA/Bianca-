  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Caractéristiques */}
        <div className="flex flex-wrap gap-6 mt-8 text-gray-700">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Chaque pièce a été pensée pour allier confort et élégance. Contactez Bianca pour une visite privée 
                et laissez-vous séduire par cette opportunité unique.
              </p>
            </div>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 bg-amber-600 text-white rounded-full font-semibold hover:bg-amber-700 transition-all shadow-md"
            >
